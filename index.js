function fnccopytext()
{
   ...
   document.getElementById('unq').style.color = 'peru';
}
function fnccopytext1()
{
   document.getElementById('unq1').style.color = 'peru';
}
function fnccopytext2()
{
   document.getElementById('unq2').style.color = 'peru';
}
function fnccopytext3()
{
   document.getElementById('unq3').style.color = 'peru';
}
function fnccopytext4()
{
   document.getElementById('unq4').style.color = 'peru';
}
